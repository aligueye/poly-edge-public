...
const (
	SignalService_GetSignal_FullMethodName = "/polyedge.SignalService/GetSignal"
)
...
type SignalServiceClient interface {
	GetSignal(ctx context.Context, in *MarketState, opts ...grpc.CallOption) (*Signal, error)
}
...
func (c *signalServiceClient) GetSignal(ctx context.Context, in *MarketState, opts ...grpc.CallOption) (*Signal, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Signal)
	err := c.cc.Invoke(ctx, SignalService_GetSignal_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SignalServiceServer interface {
	GetSignal(context.Context, *MarketState) (*Signal, error)
...
func (UnimplementedSignalServiceServer) GetSignal(context.Context, *MarketState) (*Signal, error) {
...
func _SignalService_GetSignal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SignalService_GetSignal_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SignalServiceServer).GetSignal(ctx, req.(*MarketState))
	}
...
var SignalService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "polyedge.SignalService",
	...
	Metadata: "internal/grpc/proto/signals.proto",
}
